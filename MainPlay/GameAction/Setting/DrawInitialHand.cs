...
public class DrawInitialHand : GameAction
{
    ...
    {
        List<CardComponent> listDraw = investigator.InvestigatorDeck.ListCards.GetRange(investigator.InvestigatorDeck.ListCards.Count - (GameData.DrawInitialHand - investigator.Hand.ListCards.Count), GameData.DrawInitialHand - investigator.Hand.ListCards.Count);
