        ...
        set
        {
            ...
            switch (state)
            {
                case ButtonState.Ready:
                    ...
                    //colorBlockGreen.normalColor = colorBlockGreen.selectedColor = new Color(0.75f, 1f, 0.75f);
                ...
                case ButtonState.StandBy:
                    ...
                    //colorBlockRed.normalColor = colorBlockRed.selectedColor = new Color(0.6f, 0.5f, 0.3f);
